...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2023 at 04:47 AM
...
(4, 'ITS', 'IT Support', '0', '2023-01-07 08:19:28', '2023-01-07');
...
CREATE TABLE `mahasiswa` (
  ...
  `status` char(1) NOT NULL COMMENT '0:Tidak Aktif | 1:Aktif | 2:Lulus | 3:Keluar',
...
CREATE TABLE `user` (
  ...
  `level` char(1) NOT NULL COMMENT '0:Admin | 1:Isntruktur | 2:Mahasiswa',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
